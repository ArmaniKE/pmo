      ...
      <div className="border-3 border-[#002F6C] rounded-2xl p-9 ml-10 mr-10">
        ...
        <div className="mt-5">
          <div className="items-center py-5 px-3 flex flex-row justify-between text-lg font-semibold text-[#002F6C]">
            ...
            <div className="w-[38%]">Система управления задачами, популярная среди разработчиков</div>
            <div className="w-[38%]">Гибкость, мощные возможности для Agile и Scrum</div>
          </div>
          <div className="items-center py-5 px-3 flex flex-row justify-between text-lg font-semibold text-[#002F6C]">
            <img src="/tools/trello.svg" className="w-33"/>
            <div className="w-[38%]">Доска для управления задачами с карточками</div>
            <div className="w-[38%]">Простота, удобство для небольших команд</div>
          </div>
          <div className="items-center py-5 px-3 flex flex-row justify-between text-lg font-semibold text-[#002F6C]">
            <img src="/tools/asana.svg" className="w-33"/>
            <div className="w-[38%]">Программа для планирования проектов</div>
            <div className="w-[38%]">Подходит для крупных компаний, аналитика и отчеты</div>
          </div>
          <div className="items-center py-5 px-3 flex flex-row justify-between text-lg font-semibold text-[#002F6C]">
            <img src="/tools/ms.svg" className="w-33"/>
            <div className="w-[38%]">Органайзер задач с расширенными возможностями</div>
            <div className="w-[38%]">Интуитивный интерфейс, интеграции с другими сервисами</div>
          </div>
        </div>
      </div>
    </div>
